This is a [Processing3](https://processing.org/) sketch written in [Python](https://www.python.org/) for visualizing a two dimensional [Sierpiński Triangle](https://en.wikipedia.org/wiki/Sierpi%C5%84ski_triangle).
